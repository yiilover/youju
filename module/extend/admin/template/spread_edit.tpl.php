...
<td>
<input type="radio" name="post[mid]" value="6" id="m_6"<?php if($mid == 6) echo ' checked';?>/><label for="m_5"> 新房</label>

<input type="radio" name="post[mid]" value="5" id="m_5"<?php if($mid == 5) echo ' checked';?>/><label for="m_5"> 售房</label>
<input type="radio" name="post[mid]" value="7" id="m_7"<?php if($mid == 7) echo ' checked';?>/><label for="m_5"> 租房</label>
<input type="radio" name="post[mid]" value="6" id="m_6"<?php if($mid == 16) echo ' checked';?>/><label for="m_6"> 求购</label>
