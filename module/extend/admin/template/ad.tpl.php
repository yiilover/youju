...
<th>广告位名称</th>
<th>规格(px)</th>
<th title="(<?php echo $AJ['money_unit'];?>/月)">价格</th>
<th>广告</th>
<th>HTML调用代码</th>
<th>JS调用代码</th>
<th width="120">操作</th>
...
<td><input type="text" size="12" <?php if($v['typeid'] > 1 && $v['typeid'] < 5) { ?>value="<script type=&quot;text/javascript&quot; src=&quot;{AJ_STATIC}file/script/A<?php echo $v['pid'];?>.js&quot;></script>"<?php } else { ?>value="不支持" disabled<?php } ?> onmouseover="this.select();"/></td>
