...
<td><input name="setting[survey_domain]"  type="text" size="30" value="<?php echo $survey_domain;?>"/><?php tips('例如 http://survey.aijiacms.com/<br/>请将此域名绑定至网站survey目录');?></td>
</tr>
<tr>
...
<td><input name="setting[wap_domain]"  type="text" size="30" value="<?php echo $wap_domain;?>"/><?php tips('例如 http://wap.aijiacms.com/<br/>请将此域名绑定至网站wap目录');?></td>
</tr>
<tr>
...
<td>
<input type="radio" name="setting[wap_goto]" value="1"  <?php if($wap_goto) echo 'checked';?>/> 开启&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[wap_goto]" value="0"  <?php if(!$wap_goto) echo 'checked';?>/> 关闭
</td>
</tr>
</table>
