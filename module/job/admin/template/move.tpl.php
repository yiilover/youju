...
<input type="radio" name="fromtype" value="itemid" <?php echo $itemid ? 'checked' : '';?> id="f_2"/><label for="f_2">从指定信息ID</label>
</td>
<td></td>
<td>&nbsp;目标分类</td>
</tr>
...
<tr>
<td>&nbsp;&nbsp;&nbsp;<a href="?file=category&mid=<?php echo $moduleid;?>" target="_blank" class="f_b t">分类ID查询</a></td>
<td> </td>
