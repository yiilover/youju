...
<td><input type="text" size="5" name="setting[fee_view_resume]" value="<?php echo $fee_view_resume;?>"/> <?php echo $fee_currency == 'money' ? $AJ['money_unit'] : $AJ['credit_unit'];?>/条</td>
</tr>
<tr>
...
<td><input type="text" size="5" name="setting[fee_add_resume]" value="<?php echo $fee_add_resume;?>"/> <?php echo $fee_currency == 'money' ? $AJ['money_unit'] : $AJ['credit_unit'];?>/条</td>
</tr>
<tr>
