...
class photo {
    ...
    function photo($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','areaid','level','title','style','fee','introduce','thumb','banner','status','hits','open','password','question','answer','username','addtime', 'editor','edittime','ip','template', 'linkurl','filepath','domain','note','houseid','housename');
    }
	...
	function update($itemid) {
		...
		$item['houseid'] = $item['houseid'];
		$linkurl = tupianurl($item);
