...
<br/>
<div class="t_c">
<?php echo type_select('photo', 1, 'post[typeid]', '请选择分类', $typeid, 'id="typeid"');?><input type="submit" value=" 更 新 " class="btn"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value=" 预 览 " class="btn" onclick="window.open('<?php echo $MOD['linkurl'].$item['linkurl'];?>');"/></div>
</form>
