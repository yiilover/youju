...
function Copy_Line_Text($cityid,$str_price,$str_month)
{	
	// $str_price='2423,2277';
	// $$str_month ='"02","03"';
	$content = '{
...
"title": {
 ...
 "y_axis":{"grid-colour":"#E7E7E7","colour":"#A5A5A5","steps":1000,"min":3000,"max":12000},
 "bg_colour":"#FFFFFF"
}';

	if($handle = @fopen(AJ_ROOT."/data-files/line_newhouse_$cityid.txt","w+"))
