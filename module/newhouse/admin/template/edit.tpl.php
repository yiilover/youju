...
<tr>
<td class="tl"><span class="f_hid">*</span> 曲线图数值</td>
<td>
<input type="text" name="post[lineprice]" value="<?php echo $lineprice;?>"  size="45"/>(格式:1000,2000)
 </td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 月份</td>
<td>
<input type="text"  name="post[linedate]" value="<?php echo $linedate;?>" size="45" />格式: 201207,201208
 </td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 价格销售</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 编辑点评</td>
<td>
