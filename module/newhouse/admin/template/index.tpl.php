...
<a href="?moduleid=2&file=message&action=&typeid=1&title=<?php echo $v['title'];?>">意向</a> |
<a href="?moduleid=3&file=wenfang&item_id=<?php echo $v['itemid'];?>">问房</a> |
<a href="javascript:Dwidget('?moduleid=12&file=<?php echo $file;?>&houseid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 图片列表');">相册</a> |
<a href="?moduleid=8&file=<?php echo $file;?>&houseid=<?php echo $v['itemid'];?>">资讯</a> |
<a href="?moduleid=14&file=<?php echo $file;?>&houseid=<?php echo $v['itemid'];?>">视频</a> |  
