...
class sell {
    ...
    function sell($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','mycatid','areaid','typeid','level','title','tag','style','fee','introduce','price','days','thumb','thumb1','thumb2','tag','status','hits','username','totime','editor','addtime','adddate','edittime','editdate','ip','template','linkurl','filepath','elite','note','company','truename','telephone','mobile','address','email','msn','qq','ali','skype','housename','houseid','room','hall','balcony','houseearm','floor1','floor2','zhuanxiu','cqxz','houseyear','map','toward','toilet','bus');
    }
