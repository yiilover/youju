...
<td class="f_blue"><?php echo $promo_amount;?> <?php echo $promo_type ? '天' : $AJ['money_unit'];?></td>
</tr>
<?php } ?>
<tr>
...
<td class="f_blue"><input type="text" name="post[pay]" size="5" value="<?php echo $pay;?>"/> <?php echo $AJ['money_unit'];?>&nbsp;&nbsp;&nbsp;<a href="?moduleid=2&file=record&action=add&username=<?php echo $username;?>" class="t" target="_blank">[<?php echo $AJ['money_name'];?>管理]</a>&nbsp;&nbsp;<span class="f_gray">(会员当前账户余额:<?php echo $user['money'];?><?php echo $AJ['money_unit'];?>)</span></td>
</tr>
<tr>
