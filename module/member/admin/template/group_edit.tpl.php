...
<td><input type="text" size="20" name="setting[discount]" id="discount" value="<?php echo $discount;?>"/> % 折扣仅限系统收费，不针对会员房源</td>
</tr>
