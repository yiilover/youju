...
function CommunitySearch(_CommunityName){
	...
	if (sOldValue != s){
		$('#vid').val('');
		$('#divShow').html('<div style="height:28px;line-height:28px;color:#CCCCCC"><img src="'+imgUrl+'common/loading_nx.gif" align="absmiddle"/>加载中,请稍候...</div>');
