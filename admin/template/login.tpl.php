...
<form method="post" action="?"  onsubmit="return Dcheck();">
	...
	<table cellspacing="0" align="center">
		...
		<tr>
			...
			<td><?php include template('passwordA', 'chip');?></td>
		</tr>
			<?php if($AJ['captcha_admin']) { ?>		</tr>
			<td align="right">验 证 码：</td>
			<td><?php include template('captchaA', 'chip');?></td>
		</tr><?php } ?>
		<tr>
			<td></td>
		...
		<tr><td colspan="2" class="copyright">Powered by <strong><a href="http://www.haoid.cn/" target="_blank">好站长资源<?php echo $edition;?></a></strong> &copy; 2011-<?php echo date('Y');?></td></tr>
