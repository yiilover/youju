...
<input type="button" value="导 出" class="btn" onclick="window.location='?file=<?php echo $file;?>&item=<?php echo $item;?>&action=export';"/>&nbsp;
...
一行一个，关键词和链接用|分割，例如：aijiacms|http://www.aijiacms.com
</td>
</tr>
<tr>
<td></td>
