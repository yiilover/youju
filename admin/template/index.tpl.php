...
<title>管理中心 - <?php echo $AJ['sitename']; ?> - Powered By 爱家房产<?php echo $edition;?> V<?php echo AJ_VERSION; ?> R<?php echo AJ_RELEASE;?> <?php echo strtoupper(AJ_CHARSET);?> <?php echo strtoupper(AJ_LANG);?></title>
</head>
