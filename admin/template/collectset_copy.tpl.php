...
<td>
	...
	<input type="radio" class="radio" name="contpagemode" value="2"<?php if($myCollect['contpagemode']==1) echo ' checked="checked"';?> />分页列表
	<input type="radio" class="radio" name="contpagemode" value="3"<?php if($myCollect['contpagemode']==2) echo ' checked="checked"';?> />下一页
