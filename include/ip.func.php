...
function convertip($ip) {
	if(is_file(AJ_ROOT.'/file/ipdata/wry.dat')) {
		$ipdatafile = AJ_ROOT.'/file/ipdata/wry.dat';
		...
		return $ipaddr;
	} else if(is_file(AJ_ROOT.'/file/ipdata/tiny.dat')) {
		$ipdatafile = AJ_ROOT.'/file/ipdata/tiny.dat';
	...
	} else if(is_file(AJ_ROOT.'/file/ipdata/sina.dat')) {
