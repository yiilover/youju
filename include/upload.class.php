...
class upload {
	...
	function save() {
        ...
        if(!is_writable(AJ_ROOT.'/'.$this->savepath)) return $this->_($L['upload_unwritable']);
		if(!move_uploaded_file($this->file, AJ_ROOT.'/'.$this->saveto) && !copy($this->file, AJ_ROOT.'/'.$this->saveto)) return $this->_($L['upload_failed']);
