...
<img src="<?php echo AJ_PATH;?>api/oauth/qq/ico.png" align="absmiddle"/> <a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=http://connect.opensns.qq.com/" target="_blank" class="t">帐号申请</a>
</td>
</tr>
...
<img src="<?php echo AJ_PATH;?>api/oauth/sina/ico.png" align="absmiddle"/> <a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=http://open.t.sina.com.cn/" target="_blank" class="t">帐号申请</a>
</td>
</tr>
...
<img src="<?php echo AJ_PATH;?>api/oauth/baidu/ico.png" align="absmiddle"/> <a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=http://developer.baidu.com/ms/oauth/" target="_blank" class="t">帐号申请</a>
</td>
</tr>
...
<img src="<?php echo AJ_PATH;?>api/oauth/netease/ico.png" align="absmiddle"/> <a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=http://reg.163.com/help/help_oauth2.html" target="_blank" class="t">帐号申请</a>
</td>
</tr>
...
<img src="<?php echo AJ_PATH;?>api/oauth/msn/ico.png" align="absmiddle"/> <a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=http://manage.dev.live.com/" target="_blank" class="t">帐号申请</a>
</td>
</tr>
