...
$urls['php']['item'][5] = array('example'=>'('.$L['url_php'].') tupian.php?houseid=1&itemid=1','index'=>'../newhouse/tupian.php?houseid={$houseid}&p={$itemid}', 'page'=>'tupian.php?houseid={$houseid}&p={$itemid}');
?>