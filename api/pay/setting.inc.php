...
<tr>
<td class="tl">提示信息：</td>
<td>以下接口需要申请的是B2C<span class="f_red">即时到帐</span>交易，接口功能类似，一般只需要开通任意一个即可</td>
</tr>
<tr>
...
<input type="radio" name="pay[tenpay][enable]" value="0"  <?php if(!$tenpay['enable']) echo 'checked';?> onclick="Dd('tenpay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=http://mch.tenpay.com/market/opentrans_immediately.shtml" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<td><input type="text" size="30" name="pay[tenpay][notify]" value="<?php echo $tenpay['notify'];?>"/> <?php tips('默认为notify.php 保存于 api/pay/tenpay/notify.php<br/>建议你修改此文件名，然后在此填写新文件名，以防受到骚扰');?></td>
</tr>
<tr>
...
<input type="radio" name="pay[alipay][enable]" value="0"  <?php if(!$alipay['enable']) echo 'checked';?> onclick="Dd('alipay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=https://b.alipay.com/order/productDetail.htm?productId=2012111200373124" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl"><a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=www.99bill.com" target="_blank" class="t"><strong>快钱支付 99bill</strong></a></td>
<td>
...
<input type="radio" name="pay[kq99bill][enable]" value="0"  <?php if(!$kq99bill['enable']) echo 'checked';?> onclick="Dd('kq99bill').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=www.99bill.com" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
...
<tr>
<td class="tl">接收服务器通知文件名</td>
<td><input type="text" size="30" name="pay[kq99bill][notify]" value="<?php echo $kq99bill['notify'];?>"/> <?php tips('默认为notify.php 保存于 api/pay/kq99bill/notify.php<br/>建议你修改此文件名，然后在此填写新文件名，以防受到骚扰');?></td>
</tr>
<tr>
<td class="tl">扣除手续费</td>
